...
// 
class Reflection extends Observable {

	constructor(options) {
		console.log('new Reflection()');
		super();
		options = options || {};
	...
	reflect() {
		console.debug('Reflection.prototype.reflect()');
	...
	queryActions(device, action) {
		console.debug('Reflection.prototype.queryActions()', device && device.id, action);
	...
	experiment() {
		console.debug('Reflection.prototype.experiment()');
		var output;
		...
		if (output) {
			console.debug('Reflection.prototype.experiment().output()', output);
	...
	fulfill() {
		console.debug('Reflection.prototype.fulfill()');
