...
The basic premise that this project is built on is that full automation requires a void of concepts that can be filled randomly with greater or lesser success depending on sensor input. The following building blocks are used to achieve this:
