...
This is the basic premise that this project is buid on. Automation requires a void of concepts that can be filled randomly with greater or lesser success depending on sensor input.
